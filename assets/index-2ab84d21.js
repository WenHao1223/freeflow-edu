 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(x,j){var K=x.length;x.push(j);e:for(;0<K;){var pe=K-1>>>1,Ce=x[pe];if(0<i(Ce,j))x[pe]=j,x[K]=Ce,K=pe;else break e}}function n(x){return x.length===0?null:x[0]}function r(x){if(x.length===0)return null;var j=x[0],K=x.pop();if(K!==j){x[0]=K;e:for(var pe=0,Ce=x.length,oa=Ce>>>1;pe<oa;){var pr=2*(pe+1)-1,ac=x[pr],mr=pr+1,aa=x[mr];if(0>i(ac,K))mr<Ce&&0>i(aa,ac)?(x[pe]=aa,x[mr]=K,pe=mr):(x[pe]=ac,x[pr]=K,pe=pr);else if(mr<Ce&&0>i(aa,K))x[pe]=aa,x[mr]=K,pe=mr;else break e}}return j}function i(x,j){var K=x.sortIndex-j.sortIndex;return K!==0?K:x.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,g=!1,v=!1,_=!1,w=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(x){for(var j=n(u);j!==null;){if(j.callback===null)r(u);else if(j.startTime<=x)r(u),j.sortIndex=j.expirationTime,e(l,j);else break;j=n(u)}}function E(x){if(_=!1,m(x),!v)if(n(l)!==null)v=!0,sc(A);else{var j=n(u);j!==null&&oc(E,j.startTime-x)}}function A(x,j){v=!1,_&&(_=!1,p(D),D=-1),g=!0;var K=d;try{for(m(j),h=n(l);h!==null&&(!(h.expirationTime>j)||x&&!Lt());){var pe=h.callback;if(typeof pe=="function"){h.callback=null,d=h.priorityLevel;var Ce=pe(h.expirationTime<=j);j=t.unstable_now(),typeof Ce=="function"?h.callback=Ce:h===n(l)&&r(l),m(j)}else r(l);h=n(l)}if(h!==null)var oa=!0;else{var pr=n(u);pr!==null&&oc(E,pr.startTime-j),oa=!1}return oa}finally{h=null,d=K,g=!1}}var C=!1,k=null,D=-1,X=5,z=-1;function Lt(){return!(t.unstable_now()-z<X)}function us(){if(k!==null){var x=t.unstable_now();z=x;var j=!0;try{j=k(!0,x)}finally{j?cs():(C=!1,k=null)}}else C=!1}var cs;if(typeof f=="function")cs=function(){f(us)};else if(typeof MessageChannel<"u"){var tm=new MessageChannel,II=tm.port2;tm.port1.onmessage=us,cs=function(){II.postMessage(null)}}else cs=function(){w(us,0)};function sc(x){k=x,C||(C=!0,cs())}function oc(x,j){D=w(function(){x(t.unstable_now())},j)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(x){x.callback=null},t.unstable_continueExecution=function(){v||g||(v=!0,sc(A))},t.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<x?Math.floor(1e3/x):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(x){switch(d){case 1:case 2:case 3:var j=3;break;default:j=d}var K=d;d=j;try{return x()}finally{d=K}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(x,j){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var K=d;d=x;try{return j()}finally{d=K}},t.unstable_scheduleCallback=function(x,j,K){var pe=t.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?pe+K:pe):K=pe,x){case 1:var Ce=-1;break;case 2:Ce=250;break;case 5:Ce=1073741823;break;case 4:Ce=1e4;break;default:Ce=5e3}return Ce=K+Ce,x={id:c++,callback:j,priorityLevel:x,startTime:K,expirationTime:Ce,sortIndex:-1},K>pe?(x.sortIndex=K,e(u,x),n(l)===null&&x===n(u)&&(_?(p(D),D=-1):_=!0,oc(E,K-pe))):(x.sortIndex=Ce,e(l,x),v||g||(v=!0,sc(A))),x},t.unstable_shouldYield=Lt,t.unstable_wrapCallback=function(x){var j=d;return function(){var K=d;d=j;try{return x.apply(this,arguments)}finally{d=K}}}})(yv);gv.exports=yv;var YI=gv.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pi(t,e){return zo(t,"POST","/v1/accounts:signInWithIdp",Jr(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr=new Tu("@firebase/firestore");function ws(){return zr.logLevel}function O(t,...e){if(zr.logLevel<=W.DEBUG){const n=e.map(Rp);zr.debug(`Firestore (${ss}): ${t}`,...n)}}function In(t,...e){if(zr.logLevel<=W.ERROR){const n=e.map(Rp);zr.error(`Firestore (${ss}): ${t}`,...n)}}function Bi(t,...e){if(zr.logLevel<=W.WARN){const n=e.map(Rp);zr.warn(`Firestore (${ss}): ${t}`,...n)}}function Rp(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i2=new he(M.comparator);function Sn(){return i2}const lT=new he(M.comparator);function xs(...t){let e=lT;for(const n of t)e=e.insert(n.key,n);return e}function uT(t){let e=lT;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Rr(){return Qs()}function cT(){return Qs()}function Qs(){return new as(t=>t.toString(),(t,e)=>t.isEqual(e))}const s2=new he(M.comparator),o2=new Fe(M.comparator);function G(...t){let e=o2;for(const n of t)e=e.add(n);return e}const a2=new Fe(Y);function l2(){return a2}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rO{constructor(){this.$i=!1,this.Ui=!1,this.Wi=100,this.Gi=8}initialize(e,n){this.zi=e,this.indexManager=n,this.$i=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.ji(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Hi(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new nO;return this.Ji(e,n,o).next(a=>{if(s.result=a,this.Ui)return this.Yi(e,n,o,a.size)})}).next(()=>s.result)}Yi(e,n,r,i){return r.documentReadCount<this.Wi?(ws()<=W.DEBUG&&O("QueryEngine","SDK will not create cache indexes for query:",ii(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Wi,"documents"),T.resolve()):(ws()<=W.DEBUG&&O("QueryEngine","Query:",ii(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Gi*i?(ws()<=W.DEBUG&&O("QueryEngine","The SDK decides to create cache indexes for query:",ii(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,nn(n))):T.resolve())}ji(e,n){if(Ry(n))return T.resolve(null);let r=nn(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=Ld(n,null,"F"),r=nn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=G(...s);return this.zi.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.Zi(n,a);return this.Xi(n,u,o,l.readTime)?this.ji(e,Ld(n,null,"F")):this.es(e,u,n,l)}))})))}Hi(e,n,r,i){return Ry(n)||i.isEqual(F.min())?T.resolve(null):this.zi.getDocuments(e,r).next(s=>{const o=this.Zi(n,s);return this.Xi(n,o,r,i)?T.resolve(null):(ws()<=W.DEBUG&&O("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),ii(n)),this.es(e,o,n,Lx(i,-1)).next(a=>a))})}Zi(e,n){let r=new Fe(aT(e));return n.forEach((i,s)=>{qu(e,s)&&(r=r.add(s))}),r}Xi(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Ji(e,n,r){return ws()<=W.DEBUG&&O("QueryEngine","Using full collection scan to execute query:",ii(n)),this.zi.getDocumentsMatchingQuery(e,n,ir.min(),r)}es(e,n,r,i){return this.zi.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
